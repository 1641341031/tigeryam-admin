...
<script>
  import {fetchList, createProductCate, updateProductCate, getProductCate} from '@/api/productCate.js';
  import {fetchListWithAttr} from '@/api/productAttrCate.js';
  import {getProductAttrInfo} from '@/api/productAttr.js';
