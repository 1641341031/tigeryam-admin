    ...
    <el-card shadow="never" class="standard-margin">
      ...
      <div class="form-container-border">
        ...
        <el-row>
          ...
          <el-col class="form-border font-small" :span="18">{{formatTime(orderReturnApply.createTime)}}</el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          ...
          <el-col class="form-border font-small" :span="18" style="height:100px">
            <img v-for="(item, index) in proofPics" :key="index" style="width:80px;height:80px" :src="item">
          </el-col>
        </el-row>
      </div>
      <div class="form-container-border">
        ...
        <el-row>
          ...
          <el-col class="form-border font-small" :span="18">{{formatRegion(currentAddress)}}</el-col>
        </el-row>
        <el-row>
